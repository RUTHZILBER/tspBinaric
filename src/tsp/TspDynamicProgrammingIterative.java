...
public class TspDynamicProgrammingIterative {
  ...
  public static void main(String[] args) {
    ...
    int n2 = 4;
    double[][] distanceMatrix2 = new double[n2][n2];
    for (double[] row : distanceMatrix2) java.util.Arrays.fill(row, 10000);
    distanceMatrix2[0][1] = 10;
    distanceMatrix2[1][2] = 12;
    distanceMatrix2[2][3] = 2;
    distanceMatrix2[3][0] = 4;

    int startNode2 = 0;
    TspDynamicProgrammingIterative solver2 = new TspDynamicProgrammingIterative(startNode2, distanceMatrix2);
    // Tour: [0, 1, 2, 3, 0]
    ...
    System.out.println("Tour cost: " + solver2.getTourCost());
      ...
      for (int i = 0; i < 1000; i++) {
          System.out.println(notIn(i,7)+" "+i+" ");
     
      }
      
       System.out.println(notIn(32,7));
